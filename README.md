...
| `suite` | La puerta de entrada: traduce "heredé este repo" o "me pasaron un documento" en el comando que corresponde, cruzando el estado real del proyecto con lo que pedís. No hace trabajo, enruta. |
