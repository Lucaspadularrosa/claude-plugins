...
{
  "version": 1,
  "metadata": {"created_at": "string", "updated_at": "string", "technical_design_version_ref": "string", "greenfield": false, "notes": "string (opcional)"},
...
regenerarse. Campos opcionales de anotacion en `metadata` (`notes`, refs
adicionales) no invalidan el perfil.
